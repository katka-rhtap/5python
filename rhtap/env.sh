...
export IMAGE_URL=${IMAGE_URL-artifactory-docker-artifactory-jcr.apps.rosa.rhtap-services.xmdt.p3.openshiftapps.com/rhtap/katka-rhtap-release-test:$CI_TYPE-$TAG}
...
export GITOPS_REPO_URL=https://github.com/katka-rhtap/5python-gitops
